...
export const metadata: Metadata = {
  title: "Pranay Kumar | Full Stack Developer & AI Engineer",
  description: "Computer Engineering graduate specializing in MERN Stack Development, Agentic AI, and Distributed Systems. Building scalable web applications and intelligent solutions.",
};
