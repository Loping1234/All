...
import { CheckCircle, XCircle, Award, TrendingUp, Clock, Target, ArrowLeft, Play } from 'lucide-react';
import { updateConceptMastery } from '../lib/database';
  ...
  const trackConceptMastery = async () => {
    try {
      ...
      for (let i = 0; i < questions.length; i++) {
        ...
        // ✅ IMPROVED: Extract meaningful concept from question
  ...
  return (
    <div className="space-y-6">
      ...
      <AnimatePresence mode="wait">
        ...
        >
          <h3 className="text-2xl text-white mb-8">{currentQ.question}</h3>
