      ...
      <section className="relative min-h-screen flex items-center justify-center px-6 pt-24 pb-16 overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto text-center">
          ...
          >
            ...
            >
              <p className="text-sm text-purple-400/80 tracking-wider uppercase mb-2">How it works</p>
              <h3 className="text-2xl md:text-3xl text-white/80">From PDF to focused mastery</h3>
            </motion.div>
