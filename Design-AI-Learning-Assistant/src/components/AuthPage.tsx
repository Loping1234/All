...
import { Mail, Lock, User, ArrowLeft, AlertCircle, Loader2, Sparkles, ScanFace, Layers, LineChart } from "lucide-react";
...
export function AuthPage({ onNavigate, onAuthSuccess }: AuthPageProps) {
  ...
  const benefits = [
    {
      icon: ScanFace,
      title: "Real-time AI focus tracking",
      description: "Your webcam becomes a focus coach — drowsiness and distraction are caught as they happen.",
    },
    {
      icon: Layers,
      title: "Quizzes & flashcards from your documents",
      description: "Upload a PDF and get practice material generated automatically.",
    },
    {
      icon: LineChart,
      title: "Analytics you can act on",
      description: "Every session ends with a focus report showing exactly where your attention went.",
    },
  ];
  ...
  return (
    <div className="min-h-screen relative md:grid md:grid-cols-2">
      ...
      <div className="hidden md:flex relative flex-col justify-center px-12 lg:px-16 py-16 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-purple-600/25 via-transparent to-blue-600/20" />
        <motion.div
        ...
        />
        <motion.div
          className="absolute -bottom-32 -right-16 w-96 h-96 rounded-full bg-blue-600/25 blur-3xl"
        ...
        >
          <div className="flex items-center gap-3 mb-10">
            <div className="w-11 h-11 rounded-2xl bg-gradient-to-br from-purple-500 to-blue-500 flex items-center justify-center shadow-lg shadow-purple-500/30">
              <Sparkles className="w-5 h-5 text-white" />
            </div>
            <span className="text-xl text-white tracking-tight">LearnAI</span>
          </div>

          <h1 className="text-4xl lg:text-5xl mb-10 leading-tight bg-clip-text text-transparent bg-gradient-to-r from-white via-purple-200 to-blue-200">
            Study smarter, with AI that keeps you focused.
          </h1>
          ...
          <div className="space-y-6 mb-10">
            {benefits.map((benefit, index) => (
              ...
              >
                <div className="w-10 h-10 rounded-xl glass-panel flex items-center justify-center flex-shrink-0">
          ...
          >
            <p className="text-sm text-white/70 italic leading-relaxed">
              "The focus tracking felt strange for about five minutes — then it changed how I study.
              I can finally see where my attention actually goes."
            </p>
            <p className="text-sm text-purple-300 mt-3">— Priya, engineering student</p>
          </motion.div>
        </motion.div>
      </div>

      {/* Right: auth form */}
      <div className="flex items-center justify-center px-6 py-16 min-h-screen md:min-h-0">
      <motion.div
